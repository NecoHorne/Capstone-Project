...
//        Fabric.with(this, new Crashlytics());
    ...
    private void emailLoginSetup(){
        ...
        email = findViewById(R.id.login_activity_email_edit_text);
        password = findViewById( R.id.login_activity_password_edit_text);
        Button loginButton = findViewById( R.id.login_activity_login_button );
        ...
        TextView registerNewAccount = findViewById( R.id.login_activity_register_new );
        ...
        TextView resendVerification = findViewById( R.id.login_resend_verification );
    ...
    private void resendVerEmail() {
        ...
        // this issue was resolved by first removing the auth listener, doing the resend then using the interface of DialogCloseListener to add the listener back
        FirebaseAuth.getInstance().removeAuthStateListener(mAuthListener);
